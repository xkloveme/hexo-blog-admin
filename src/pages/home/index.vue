 ...
 * @LastEditTime: 2022-02-18 22:41:17
...
-->
<template>
<div class="flex  w-full h-screen text-gray-700 dark:text-gray-400 dark:bg-gray-800">

	<div class="flex flex-col flex-shrink-0 border-r w-full border-gray-300 bg-gray-100 dark:text-gray-400 dark:bg-gray-800">
		<button class="flex-shrink-0 relative text-sm focus:outline-none group">
			<div class="flex items-center justify-between w-full h-16 px-4 border-b border-gray-300 hover:bg-gray-300 dark:hover:bg-gray-900">
      ...
      dark:bg-gray-800">
				<a class="w-full px-4 py-2 text-left hover:bg-gray-300 dark:hover:bg-gray-900 dark:bg-gray-800" href="#">Menu Item 1</a>
				<a class="w-full px-4 py-2 text-left hover:bg-gray-300 dark:hover:bg-gray-900 dark:bg-gray-800" href="#">Menu Item 1</a>
				<a class="w-full px-4 py-2 text-left hover:bg-gray-300 dark:hover:bg-gray-900 dark:bg-gray-800" href="#">Menu Item 1</a>
			</div>
		</button>
		<div class="h-0 overflow-auto flex-grow">
			<div class="mt-3">
				<a class="flex items-center h-8 hover:bg-gray-300 dark:hover:bg-gray-900 text-sm px-3" href="#">
			...
			<div class="mt-4">
				<div class="flex items-center h-8 px-3 group">
					...
					<button class="items-center justify-center h-6 w-6 ml-auto rounded hidden group-hover:flex hover:bg-gray-300 dark:hover:bg-gray-900">
						<svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
						</svg>
					</button>
					<button class="flex items-center justify-center h-6 w-6 ml-1 rounded hover:bg-gray-300 dark:hover:bg-gray-900">
				...
				<div id="channels_list">
					<a class="flex items-center h-8  bg-gray-300 dark:bg-gray-900  dark:hover:bg-gray-900 text-sm pl-8 pr-3" href="#">
					...
					<a class="flex items-center h-8 hover:bg-gray-300 dark:hover:bg-gray-900 text-sm pl-8 pr-3" href="#">
						<svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
							<path fill-rule="evenodd" d="M9.243 3.03a1 1 0 01.727 1.213L9.53 6h2.94l.56-2.243a1 1 0 111.94.486L14.53 6H17a1 1 0 110 2h-2.97l-1 4H15a1 1 0 110 2h-2.47l-.56 2.242a1 1 0 11-1.94-.485L10.47 14H7.53l-.56 2.242a1 1 0 11-1.94-.485L5.47 14H3a1 1 0 110-2h2.97l1-4H5a1 1 0 110-2h2.47l.56-2.243a1 1 0 011.213-.727zM9.03 8l-1 4h2.938l1-4H9.031z" clip-rule="evenodd" />
						</svg>
